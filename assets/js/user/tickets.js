(async () => {
  ...
  function renderTickets(tickets) {
    ...
    ticketsGrid.innerHTML = tickets
      .map((ticket) => {
        ...
        return `
                    <article class="ticket-card overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-md"><div class="bg-amber-400 px-6 py-2 text-xs font-bold uppercase tracking-[.18em] text-amber-950">BusBooking · Travel confirmation</div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="ticket-divider mt-6 grid grid-cols-2 gap-4 pt-5 sm:grid-cols-4">
  ...
  async function cancelBooking(bookingId) {
    ...
    try {
      ...
      window.ui.showAlert("ticketsAlert", "success", responseMessage);
